...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'json_file_path',               'default': "'/home/lxw/set_d455.json'", 'description': 'allows advanced configuration'},
                           ...
                           {'name': 'color_width',                  'default': '0', 'description': 'color image width'},
                           {'name': 'color_height',                 'default': '0', 'description': 'color image height'},
                           ...
                           {'name': 'infra_fps',                    'default': '90.', 'description': ''},
                           ...
                           {'name': 'stereo_module.exposure.1',     'default': '1', 'description': 'Initial value for hdr_merge filter'},
